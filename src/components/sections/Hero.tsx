export const Hero = () => {
  return (
    <section className="relative mt-10 px-[120px] py-0 max-md:px-10 max-md:py-0">
      ...
      <div className="text-xs font-semibold text-[#5C2E2E] tracking-[0.3px] bg-[rgba(92,46,46,0.10)] px-3 py-1 rounded-full inline-block">
        JOIN US NOW
      </div>
      <div className="flex flex-col gap-[30px] max-w-[612px] mt-[30px]">
        ...
        <div className="flex items-center gap-[30px] max-sm:flex-col max-sm:w-full">
          <button className="text-base font-medium text-white shadow-[0_4px_14px_rgba(92,46,46,0.25)] cursor-pointer bg-[#5C2E2E] px-[27px] py-3.5 rounded-[10px] border-[none] max-sm:w-full">
            Join the Early Access Program
          </button>
          <button className="flex items-center gap-2.5 text-base font-medium text-[#5C2E2E] cursor-pointer">
            Learn more
            <svg
              width="24"
              height="24"
      ...
      <div className="absolute w-[536px] h-[493px] overflow-hidden shadow-[0_10px_25px_-3px_rgba(0,0,0,0.05)] rounded-xl right-[120px] top-[205px] max-md:relative max-md:mt-10 max-md:right-auto">
        <div className="w-full h-full flex flex-col items-center justify-center gap-4 bg-[rgba(92,46,46,0.15)]">
          <button className="w-16 h-16 flex items-center justify-center shadow-[0_10px_15px_-3px_rgba(0,0,0,0.10),0_4px_6px_-4px_rgba(0,0,0,0.10)] bg-[rgba(92,46,46,0.90)] rounded-full">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
